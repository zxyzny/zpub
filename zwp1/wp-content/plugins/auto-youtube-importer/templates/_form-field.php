<?php if( isset( $data ) && is_array( $data ) ) : ?>
  <div class="secondline_import_field_row secondline_import_field_row-<?php echo esc_attr( $data[ 'type' ] ); ?>">
    ...
    <?php else : ?>
        ...
        >
          <?php foreach( $data[ 'options'] as $option_key => $option_value ) : ?>
            <?php if( is_array( $option_value ) ) : ?>
              <option value="<?php echo esc_attr( $option_key ); ?>" <?php echo ( isset( $data[ 'value' ] ) ? youtube_importer_secondline_utility_selected( $data[ 'value' ], $option_key, false ) : '' ) ?>
      ...
      <?php elseif( $data[ 'type' ] === 'media_image_id' ) : ?>
        ...
        <div class="secondline_import_field_media_image_handler">
          ...
          <?php endif; ?>
          <span class="button button-primary"><?php echo esc_html__( 'Set Image', 'auto-youtube-importer' ); ?></span>
          <span class="button button-secondary button-delete" <?php echo $attachment_id === '' ? 'style="display:none;"' : ''; ?>>
            <?php echo esc_html__( 'Remove Image', 'auto-youtube-importer' ); ?>
          </span>
        </div>
      <?php else : ?>
    ...
    <?php if( isset( $data[ 'description' ] )  ) : ?>
      <div class="secondline_import_field_description"><?php echo wp_kses($data[ 'description' ], array(
